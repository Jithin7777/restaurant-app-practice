    ...
    <section id="hero" className="flex w-full items-center justify-center">
      <div className="relative flex min-h-[100vh] w-full items-center justify-center bg-black">
        ...
        <div className="head-container z-50 flex flex-col gap-9 h-full w-full max-w-[1300px] items-center justify-center">
          <div className="head-hero flex w-fit flex-col items-center justify-center gap-2 mt-16">
            <h1
              style={{ fontFamily: "var(--font-gotu)" }}
              className=" text-[#fff4e3] text-5xl  lg:leading-[80px] sm:text-5xl md:text-8xl text-center md:tracking-[-5.12px]"
            >
              Welcome to
              <br />
              Lara restaurant
            ...
            <p className="font-poppins text-white text-center text-sm uppercase tracking-[4.4px]">
              TURKISH BBQ & MEZE BAR HOUSE
            </p>
          </div>
          <div className="hero-button w-full flex flex-col justify-center items-center md:flex-row gap-4">
            <Link href="/menu">
              <Button
                style={{ backgroundColor: "hsl(38 41% 55%)" }}
                className="relative py-7 px-10 font-medium uppercase transition-colors hover:bg-primary/90 before:absolute 
        ...
        <div className="absolute bottom-20 z-40" onClick={scrollToBottom}>
          <Button
            className="down-button flex items-center justify-center px-1 bg-transparent rounded-full text-white hover:bg-amber-50 hover:text-black "
            variant="outline"
          >
