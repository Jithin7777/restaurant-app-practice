    ...
    >
      <div className="flex w-full max-w-[1300px] flex-col items-center gap-2">
        ...
        <div className="flex h-full w-full items-center justify-between">
          ...
          <div className="hidden flex-row items-center justify-center gap-[3.48rem] md:flex text-white">
            <Button
              asChild
              variant="link"
          ...
          <div className="hidden items-center justify-center gap-[2.5rem] md:flex">
            ...
            >
              <Link href="/table-booking">
                <Button style={{ backgroundColor: "hsl(38 41% 55%)" }} className="relative flex items-center justify-center gap-3 px-10 py-7 font-medium uppercase transition-colors duration-300 ease-in-out before:absolute before:inset-0 before:-z-[1] before:h-full before:w-full before:border-2 before:border-transparent before:transition-all before:content-[''] hover:bg-primary/90 before:hover:left-1 before:hover:top-1 before:hover:rounded-xl before:hover:border-b-primary before:hover:border-r-primary group-hover:translate-x-1">
                  Book A Table
                  <Icons.rightArrow />
                </Button>
              </Link>
